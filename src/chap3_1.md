...
### 同人誌・ZINE
執筆している2026年4月では、Podcastばんぐみが技術同人誌やZINEを作成することが多くなった印象があります。この本もそれらの兆候を受けて改訂する動きとなりました。特にZINEを出される番組さんが多く、文フリなどに出展されていた番組さんも多く見かけました。この本のアンケートでもいくつかの番組にご協力を依頼しています。

#### なぜ音声メディアが本なのか？
基本的にPodcastは無形の資産となります。つまり、創造性の高いものではあるのですが、情報であるがゆえに物理の形を持ちません。しかし、本は印刷することで物理的な紙の束、つまり本となります。

もともとPodcastをやられている方々はクリエイティブだったり、こだわりが強い方が多い（個人の）印象です。そんな中、本を作ることが簡単になり、また情報も浸透してきた結果、物理的なモノとしての本を作ってみたい方々が増えたのではないでしょうか。

#### いつの時代も両輪は強い、そして楽しい
音声メディアであるPodcastと文章メディアである本は、それぞれに強みや特色があります。これはメリデメといった比較するものというよりは両方を備えることでより多くの人にリーチできたり、伝えられたり、そして何よりもそれぞれの楽しさを味わうことができます。苦労も増えますが、ぜひこういったマルチメディア展開も考えてみるとより楽しめるでしょう。

### rooom
rooomはPodcast特化のサブスクリプション型メンバーシップサービスです。つまり、YouTubeのメンバーシップのようなものをPodcast番組にも追加できるサービスとなっています。

![aozorafmもrooomに参加しています](./images/chap3-tips/rooom_01.png)

Podcast番組について交流する場合はSNSやDiscord、リアルのイベントなどを用いる必要がありました。しかし、他のサービスはPodcast専用ではないですし、リアルのイベントではコストが高すぎます。しかし、rooomはPodcastが前提のサービスなので、Podcast配信者やリスナーが使いやすいようにできています。

https://rooom.listen.style/p/aozorafm

その使いやすさはぜひrooomにアクセスして確かめてみてください。現在は抽選制なので、希望すれば誰でも自分の番組を追加できるわけではないですが、興味がある人は申し込んでみるとよいでしょう。

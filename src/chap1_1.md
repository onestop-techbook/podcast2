...
![2005年頃のGoogleTrends](./images/listen-to-podcasts/podcast_trends_around_2005.png)
...
### Podcastへの関心の高まり
以下はGoogle Trendsで日本国内・過去5年間の「Podcast」の検索状況をまとめたグラフです。上述の通り2025年の年末頃からぐっと検索される機会が伸びており、2026年も直近5年ではかなりの高い水準で推移しています。これにはPodcastに関する新しい潮流が存在することを示しています。
...
### 新潮流 Video Podcast(Vodcast)
音声を配信するPodcastにVideoを足すからVideo Podcast(Vodcast)なんて話ではなく、1つのコンテンツを視聴者の好みや生活スタイルに合わせて提供できるようにしているのがPodcastの新しい流れです。以下のような収録・構成・配信スタイルを取り、様々な視聴者層に向けて複数の媒体で配信をしており、1回の収録を様々な場所で活かす一石三鳥以上の狙いが見えてきます。

- Podcastの収録中にカメラを回し、映像は動画視聴サイトに本編とショート動画を投稿
- 収録内容を記事化し、番組ブログとして配信   
- 音声のみ切り出してPodcastとして配信

筆者が存じ上げている範囲で国内の有名番組では「歴史を面白く学ぶコテンラジオ(COTEN RADIO)」や「ゆる言語学ラジオ」などが音声と映像のハイブリッド化を先駆けて着手しています。どちらの番組も「まず、Youtubeの動画やショート動画の視覚的コンテンツからファンを獲得し、深く楽しみたい人向けにPodcast(音声配信)の長尺トークに引き込む」という、上記Video Podcastの王道スタイルを確立しています。ながら聞きできるPodcastの良さは活かしつつ、より広い視聴者層に向けたコンテンツの提供を行うという新たな潮流も発生しています。  

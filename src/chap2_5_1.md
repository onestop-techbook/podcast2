...
![MPM-1000U](./images/starting-to-podcasts/mpm1000u.png){width=40%}
...
### マランツ MPM-2000U
2026年に入り、7年ほど使っていたMPM-1000Uもガタが来たのかプツプツというノイズが乗るようになりました。これが私から出ているノイズなのか、マイクの不具合なのか分かりませんが、そこまで高価なものでもないので買い替えることにした先がMPM-2000Uでした。

![MPM-2000U](./images/starting-to-podcasts/MPM-2000U.png){width=40%}

Podcastでもマイク選びに関しては話しているので、よかったら聴いてみてください。

https://fortegp05.github.io/aozorafm/episode/209

#### 使ってみた感想
マイクアームは付属しておらず、またAmazonでもセット売りはしていなかったので、先代のものをそのまま使用しています。しかしショックマウントは付属されていて新調したので、見た目は新しくなって気分が良いです。前述したエピソードもこのマイクで収録したのですが、いまのところまったく不満はないです。

しいて言えば、謎のトランクケース（持ち運び用？）が付属していたのが邪魔だなぁというくらいでした。

![MPM-2000Uトランクケース](./images/starting-to-podcasts/MPM-2000U_BOX.jpg){width=40%}

ただ、この2000Uも数年前の製品であり2026年現在でも後継品がでていません。5年後、10年後に買い替えるとなったときもまた悩みそうではあります。
...
![Blue Yeti](./images/starting-to-podcasts/yeti.png){width=40%}
